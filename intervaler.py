...
def getInterval(current_date_time):
	golden_hour_rising_start, golden_hour_rising_end = golden_hour(city.observer, date = current_date_time.date(), tzinfo = city.timezone, direction = SunDirection.RISING)
	golden_hour_setting_start, golden_hour_setting_end = golden_hour(city.observer, date = current_date_time.date(), tzinfo = city.timezone, direction = SunDirection.SETTING)
